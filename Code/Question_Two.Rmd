...
for (i in 15:59)
{
  ...
  ProColNames[i] = gsub("Ã¢","", ProColNames[i])
...
Procrastination <- Procrastination[which(Procrastination$ï..Age > 18),]
```
...
Descriptive_Table<-c("Annual.Income","ï..Age","2016_Est_HDI","DPMean","GPMean",
"AIPMean","SWLSPMean")

#Passes "Annual.Income","ï..Age","2016_Est_HDI","DPMean","GPMean",
#"AIPMean","SWLSPMean" variables through the descriptive report function and binds them together into one data frame

Descriptive_Table<-cbind(Descriptive_Table,rbind(Descriptive_report(Procrastination$Annual.Income),Descriptive_report(Procrastination$ï..Age),Descriptive_report(Procrastination$`2016_Est_HDI`),Descriptive_report(Procrastination$DPMean),Descriptive_report(Procrastination$GPMean),Descriptive_report(Procrastination$AIPMean),Descriptive_report(Procrastination$SWLSPMean)))
